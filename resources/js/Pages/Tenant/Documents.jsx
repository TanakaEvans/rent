...
export default function TenantDocuments({ documents = [] }) {
    return (
        <MainLayout title="My Documents">
            <Head title="My Documents" />

            <div className="mb-7">
                <h2 className="text-balance text-2xl font-extrabold tracking-tight sm:text-3xl">My Documents</h2>
                <p className="mt-1 text-sm text-muted-foreground">
                    The stored agreement for every lease on your account — view or download a copy anytime.
                </p>
            </div>
